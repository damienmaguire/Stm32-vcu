...
private:
  ...
  uint8_t CRC_8(const uint8_t *DataArray, const uint8_t Length);
  int timeoutCounter = 0;
  bool fault;
  bool hvRequest;
  uint8_t txData200[8] = {0};
  uint8_t txData2F0[8] = {0};
  uint8_t BCM_data[8] = {0};
  uint8_t Inverter_voltage[8] = {0};
  // float minCellV = 0;
  // float maxCellV = 0;
  // float minTempC = 0;
  // float maxTempC = 0;
