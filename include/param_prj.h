...
#define PINFUNCS                                                               \
  ...
  "11=HVRequest,"                                                              \
  "12=DCFCRequest, 13=BrakeVacPump, 14=CoolingFan, 15=HvActive, 16=PwmTim3, "  \
  "17=CpSpoof,"                                                                \
  "18=GS450pump"
...
enum HeatType { Noheater = 0, AmpHeater = 1, VW = 2, OutlanderHeater = 3 };
