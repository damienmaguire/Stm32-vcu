...
void Can_VAG::Task100Ms() {
  ...
  uint8_t canData[8] = {(uint8_t)(0x80 | ctr),
                        0,
                        0,
                        seq1[seqCtr],
                        seq2[seqCtr],
...
void Can_VAG::Task10Ms() {
  ...
  // contains temperature, traction control light was on without the message,
  // content doesnt seem to matter.
  canData[3] = 0;
  canData[4] = 0;
...
bool Can_VAG::Ready() { return DigIo::t15_digi.Get(); }
