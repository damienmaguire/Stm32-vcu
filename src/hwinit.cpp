...
void usart2_setup(void) {
 ...
 void nvic_setup(void) {
   ...
   *Enable Timer refresh and break interrupts * / void nvic_setup(void) {
     nvic_enable_irq(NVIC_DMA1_CHANNEL7_IRQ);
     nvic_set_priority(NVIC_DMA1_CHANNEL7_IRQ, 0xf0); // usart2_TX

     nvic_enable_irq(NVIC_DMA1_CHANNEL6_IRQ);
     nvic_set_priority(NVIC_DMA1_CHANNEL6_IRQ,
                       0xf0); // usart2_RX low priority int
     nvic_enable_irq(NVIC_DMA1_CHANNEL6_IRQ);
     nvic_set_priority(NVIC_DMA1_CHANNEL6_IRQ,
                       0xf0); // usart2_RX low priority int

     // nvic_enable_irq(NVIC_DMA1_CHANNEL3_IRQ);
     // nvic_set_priority(NVIC_DMA1_CHANNEL3_IRQ, 0x20);//usart3_RX high
     // priority int nvic_enable_irq(NVIC_DMA1_CHANNEL3_IRQ);
     // nvic_set_priority(NVIC_DMA1_CHANNEL3_IRQ, 0x20);//usart3_RX high
     // priority int
   ...
   void rtc_setup() {
     ...
     void tim_setup() {
       ...
       ////////////////////////////////////////////////////////////////////////
       gpio_set_mode(
           GPIOE, GPIO_MODE_OUTPUT_2_MHZ,          // Low speed (only need 1khz)
       ...
       void tim2_setup() {
         ...
         void tim3_setup() {
           ...
           // General purpose pwm output. Push/pull driven to +12v/gnd. Timer 3
           // Chan 3 PB0. General purpose pwm output. Push/pull driven to
           // +12v/gnd. Timer 3 Chan 2 PA7. General purpose pwm output.
           // Push/pull driven to +12v/gnd. Timer 3 Chan 1 PA6.
           ////////////////////////////////////////////////////////////////////////
           bool Fixed1K = false;
           /// PWM3
           if (Param::GetInt(Param::PWM3Func) == IOMatrix::PWM_TIM3) {
             gpio_set_mode(
                 GPIOB, GPIO_MODE_OUTPUT_2_MHZ, // Low speed (only need 1khz)
           ...
           void tim3_setup() {
             //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
             // Setup all 3 PWM ports to output a 1khz 50% duty cycle PWM signal
             // General purpose pwm output. Push/pull driven to +12v/gnd. Timer
             // 3 Chan 3 PB0. General purpose pwm output. Push/pull driven to
             // +12v/gnd. Timer 3 Chan 2 PA7. General purpose pwm output.
             // Push/pull driven to +12v/gnd. Timer 3 Chan 1 PA6.
             ////////////////////////////////////////////////////////////////////////
             bool Fixed1K = false;
             ...
             if (Param::GetInt(Param::PWM2Func) == IOMatrix::PWM_TIM3) {
               gpio_set_mode(
                   GPIOA, GPIO_MODE_OUTPUT_2_MHZ, // Low speed (only need 1khz)
             ...
             if (!Fixed1K) // No CP Spoof Selected or GS450h Oil pump or Gauges
             {
               ...
               timer_set_oc_value(TIM3, TIM_OC1,
                                  Param::GetInt(Param::Tim3_1_OC));
               timer_set_oc_value(TIM3, TIM_OC2,
                                  Param::GetInt(Param::Tim3_2_OC));
               timer_set_oc_value(TIM3, TIM_OC3,
                                  Param::GetInt(Param::Tim3_3_OC));
               timer_generate_event(TIM3, TIM_EGR_UG);
               timer_set_prescaler(TIM3, Param::GetInt(Param::Tim3_Presc));
               timer_enable_counter(TIM3);
             } else // No CP Spoof or GS450h Oil pump output selected locks TIM3
                    // Force 1khz clock (996khz)
             {
               // Set the params to indicate that custom params are being
               // ignored.
