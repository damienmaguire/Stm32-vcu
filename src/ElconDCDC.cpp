...
// This is an interface for Elcon Chargers that require DC-DC messages, based heavily on the Tesla DCDC module.
...
// Process voltage , current and temperature message from the Elcon Charger/DCDC.
